...
function Sidebar({}) {
  //  const {data: session, status } = useSession()
    ...
    return(
        <><div id="main" className=" transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start min-h-full w-full sm:w-64 bg-gradient-to-r from-indigo-700 to-indigo-900 flex-col">
                <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
                    ...
                    <p className="text-2xl leading-6 text-white mt-6">OvonRueden</p>
                </div>
                <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-400 border-b  pb-5 ">
                    <button className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  text-white rounded ">
                        ...
                        <p className="text-white text-md mt-6">Dashboard</p>
                    </button>
                    <button className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-indigo-400   rounded ">
                        ...
                        <p className="text-white text-md mt-6">Users</p>
                    </button>
                </div>
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-400 w-full  ">
                    <button  className="focus:outline-none focus:text-indigo-400 text-left  text-white flex justify-between items-center w-full py-4 space-x-14  ">
                        <p className="text-sm leading-5 text-white uppercase">Profile Overview</p>
                    ...
                    <div id="menu1" className="flex justify-start  flex-col w-full md:w-auto items-start pb-1 ">
                        <button className="flex justify-start items-center space-x-6 hover:text-white  focus:text-white  text-gray-400 rounded px-3  w-full md:w-52">
                            <svg className="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-white text-md mt-6 ">Messages</p>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white  focus:text-white  text-gray-400 rounded px-3  w-full md:w-52">
                            ...
                            <p className="text-white text-md mt-6 ">Security</p>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white  focus:text-white  text-gray-400 rounded px-3 w-full md:w-52">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-white text-md mt-6 ">Settings</p>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white  focus:text-white  text-gray-400 rounded px-3  w-full md:w-52">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-white text-md mt-6 ">Notifications</p>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white  focus:text-white  text-gray-400 rounded px-3  w-full md:w-52">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-white text-md mt-6 ">Passwords</p>
                        </button>
                        <button className="flex justify-start items-center space-x-6 hover:text-white  focus:text-white  text-gray-400 rounded px-3  w-full md:w-52">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-white text-md mt-6 ">Goals</p>
                        </button>
                    </div>
                </div>
