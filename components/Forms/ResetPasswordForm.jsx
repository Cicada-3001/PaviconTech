        ...
        >
          <div className="mb-16">
            <h3 className="text-4xl font-extrabold">
              {codeIsFull ? "RESET YOUR PASSWORD" : "PASSWORD RESET"}
            </h3>
            <p className="text-sm mt-6">
              {codeIsFull
                ? "Please reset your password. Use a strong but easy to remember password"
          ...
          <div className="mx-auto">
            <div className="w-full">
              <div className=" ounded text-center">
                <div
                  id="otp"
                  className="flex flex-row justify-center text-center px-3 mt-2"
                >
                  {inputValues.map((value, index) => {
                    return (
                      <input
                        ...
                        className="m-2 border  border-blue-300 h-12 w-12 text-center form-control rounded"
                        maxLength="1"
                      />
                    );
                  })}
                ...
                <div className="flex justify-end text-center mt-16">
                  <button
                    className="flex items-center bg-blue-600 text-white px-6 py-2 rounded cursor-pointer"
                ...
                {loading ? (
                  <div className="mt-10">
                    <button
                      disabled=""
                      type="submit"
                      className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded  bg-blue-600 text-white  hover:bg-blue-700 focus:outline-none border border-slate-50 hover:border-0"
                    >
                      <svg
                        aria-hidden="true"
                        role="status"
                        className="inline mr-2 w-4 h-4 text-white animate-spin dark:text-gray-600"
                        viewBox="0 0 100 101"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
