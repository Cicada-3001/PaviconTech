    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/" className="flex items-center">
          <div className="relative inline-flex items-center border justify-center w-20 h-20 overflow-hidden bg-grey-700 rounded-full">
              <span className="text-xl text-white uppercase">{session?.session?.user.email.charAt(0)}</span>
          </div>
          <span className="text-sm text-grey-700 ml-2 ">{session?.session?.user.email.substring(1)}</span>
