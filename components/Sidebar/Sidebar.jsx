  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <div className="relative inline-flex items-center border justify-center w-20 h-20 overflow-hidden bg-gray-100 rounded-full">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/orders" || pathname.includes("forms")
                }
              >
                {(handleClick, open) => {
                  return (
                    <>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/orders/electronics"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/orders/electronics" &&
                                "text-white"
                              }`}
                            >
                              Electronics
                          ...
                          <li>
                            <Link
                              href="/orders/furniture"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/orders/furniture" &&
                                "text-white"
                              } `}
                            >
                              Furniture
